...
const SERVER_VERSION = "2026-08-24-potentia-v68-fast-reply-starter";
...
`;
  let parsed=await createJsonWithRetry({model:"claude-haiku-4-5",maxTokens:advanced?430:330,retryMaxTokens:advanced?580:450,content:prompt});
