...
{
  "meaning": "대화의 핵심 의미와 흐름을 2~4문장으로 설명",
  "emotion": "상대에게서 읽힐 수 있는 감정 또는 태도를 가능성 중심으로 2~4문장으로 설명",
  "caution": "지금 피하면 좋은 행동이나 표현을 2~3문장으로 설명",
  "replies": [
    {"label":"가장 자연스러운 답장","text":"실제 보낼 수 있는 짧은 답장"},
    {"label":"조금 더 다정한 답장","text":"실제 보낼 수 있는 짧은 답장"},
    {"label":"조금 더 여유 있는 답장","text":"실제 보낼 수 있는 짧은 답장"}
  ],
