...
# 1) Expand self-harm coercion wording coverage, including natural Korean variants like "죽어버릴 거야".
...
# 2) Ground first-message recommendations for hobby/club contacts. Never invent weather or a feeling of "thinking of" the other person.
...
# 3) Deterministic quick-analysis guards for timing, over-messaging, old-friend scheduling, and self-harm coercion.
